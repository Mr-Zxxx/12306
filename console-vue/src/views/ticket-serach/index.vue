        ...
        <Space direction="vertical" size="middle" :style="{ width: '100%' }">
          <Card :style="{ width: '100%' }">
            <Row :style="{ maxWidth: '1150px' }">
              <Col :span="5">
              <FormItem label="出发地">
                <Select v-model:value="headSearch.fromStation" :style="{ width: '150px' }" :show-arrow="false"
              ...
              <Col :span="5">
              <FormItem label="目的地">
                <Select v-model:value="headSearch.toStation" :style="{ width: '150px' }" :show-arrow="false"
                  :show-search="true" :options="state.stationList.map((item) => ({
                    label: item.name,
                    value: item.code
                  }))">
              ...
              <Col :span="5">
              <FormItem label="出发日">
                <DatePicker v-model:value="headSearch.departureDate" :style="{ width: '150px' }" :show-arrow="false"
                  :allow-clear="false">
                </DatePicker>
              </FormItem>
              </Col>
                ...
                <Card flex :bordered="false">
                  <Row justify="space">
                    ...
                    <FormItem>
                      ...
                      <CheckboxGroup :value="headSearch.car_type" @change="
                        (value) => {
                          checkTagCardType =
                            value.length ===
                    ...
                    <FormItem>
                      ...
                      <CheckboxGroup :value="headSearch.departure" @change="
                        (value) => {
                          departureTagAll =
                    ...
                    <FormItem>
                      ...
                      <CheckboxGroup :value="headSearch.arrival" @change="
                        (value) => {
                          arrivalTagAll =
                    ...
                    <FormItem>
                      ...
                      <CheckboxGroup :style="{ minWidth: '300px', textWrap: 'nowrap' }" :value="headSearch.seat"
                        @change="
                          (value) => {
                            seatTagAll =
                              value.length ===
